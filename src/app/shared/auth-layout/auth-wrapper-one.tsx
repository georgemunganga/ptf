...
import logoImg4 from '@public/logo2.png';
...
export default function AuthWrapperOne({
  ...
  function handleSignIn() {
    toast.error(
      <Text>
        This is only for demo purposes, click on the{' '}
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col justify-between gap-x-8 px-4 py-8 pt-10 md:pt-12 lg:flex-row lg:p-6 xl:gap-x-10 xl:p-7 2xl:p-10 2xl:pt-10">
        ...
        <div className="hidden lg:flex w-7/12 items-center justify-center rounded-[20px] bg-gray-50 px-6 xl:justify-start 2xl:px-16 dark:bg-gray-100/40">
